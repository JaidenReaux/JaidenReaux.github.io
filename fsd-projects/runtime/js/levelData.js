    ...
    var levelData = [
      {
        ...
        gameItems: [
          ...
          {type: "reward", x: 900, y: groundY - 55, speed: 3, image:"img/goldstar.png", offsetX: -35, offsetY: -25, scale: 0.5},
          {type: "reward", x: 1400, y: groundY - 55, speed: 3, image:"img/goldstar.png", offsetX: -35, offsetY: -25, scale: 0.5},
         {type: "reward", x: 1700, y: groundY - 55, speed: 3, image:"img/emerald1.png", offsetX: -35, offsetY: -25, scale: 0.5},
          {type: "marker", x: 1500, y: groundY - 75, speed: -3, image:"img/up.png", offsetX: -35, offsetY: -25, scale: 0.9},
        ],
      },
      {
        name: "Robot Rampage",
